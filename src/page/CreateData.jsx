      ...
      <div className="text-xl sm:text-3xl text-center py-4 font-bold">SEND AN ANSWER WITH QUESTION</div>
        <form onSubmit={(e) => handleSubmit(e)} className="mb-20">
          <div className="flex flex-col ">
            ...
            <input type="text" placeholder="Enter the Question" className="input input-info" value={formData.question} onChange={(e) => setFormData({...formData, question: e.target.value})} />
          </div>
